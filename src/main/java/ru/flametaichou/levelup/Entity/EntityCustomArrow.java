...
public class EntityCustomArrow extends EntityArrow {
    ...
    public EntityCustomArrow(World world, double x, double y, double z, double damage) {
        super(world, x, y, z);
        setDamage(damage);
    }

    public EntityCustomArrow(World world, EntityLivingBase shooter, EntityLivingBase target, float power, float variance) {
        super(world, shooter, target, power, variance);
    }

    public EntityCustomArrow(World world, EntityLivingBase shooter, EntityLivingBase target, float power, float variance, double damage) {
        super(world, shooter, target, power, variance);
        setDamage(damage);
    }

    public EntityCustomArrow(World world, EntityLivingBase shooter, float power) {
        super(world, shooter, power);
    }

    public EntityCustomArrow(World world, EntityLivingBase shooter, float power, double damage) {
        super(world, shooter, power);
        setDamage(damage);
    }
